...
function Cards() {
    return (
        <div className=' sticky top-0 w-full'>
            <div className=' w-full h-full px-16 py-40 bg-slate-100 flex gap-5'>
                <div className='w-1/2 h-[50vh] bg-[#004d43] relative rounded-xl'>
                    <svg className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]' width="140" height="60" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='w-1/2 h-[50vh] flex gap-5'>
                    <div className='w-1/2 h-full bg-[#212121] rounded-xl relative'>
                        <img className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[45%]' src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
                    </div>
                    <div className='w-1/2 h-full bg-[#212121] rounded-xl relative'>
                        <img className='absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[40%]' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
